...
def construire_prompt_action(memoire: dict, taches_en_cours: list = None) -> str:
    ...
    return (
        ...
        + "- Ne demande pas confirmation dans ta reponse : les outils sensibles gerent eux-memes le Oui/Non\n"
        + "- Actions sensibles avec confirmation automatique : suppression de zones larges, organiser_dossier, vider_corbeille, ajouter_automatisation, ajouter_surveillance_dossier\n"
