...
def construire_prompt_conversation(memoire: dict) -> str:
    ...
    return (
        ...
        f"Tes capacités sont limitées par les outils et les permissions dont tu disposes. Quand un truc te dépasse ou n'est pas pris en charge, explique-le clairement à l'utilisateur.\n"
