...
lire_fichier(chemin: str)
lister_dossier(chemin: str)
supprimer(chemin: str)
noter(contenu: str)
lire_notes()
memoriser_contexte(cle: str, valeur: str)
lire_contexte(cle: str = None)
oublier_contexte(cle: str)
...
ajouter_commande_personnalisee(nom: str, commande: str)
...
supprimer_surveillance_dossier(chemin: str)
