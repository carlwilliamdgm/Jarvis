...
class TestBootstrapImport(unittest.TestCase):
    ...
    def setUp(self):
        ...
        datashield.safety.USE_FALLBACK = False

    def tearDown(self):
        """Nettoyer l'etat global apres chaque test."""
        datashield.safety.USE_FALLBACK = False

    @patch('datashield.safety.subprocess.run')
    @patch('datashield.safety.importlib.import_module')
    ...
    def test_bootstrap_import_never_calls_pip_on_import_error(self, mock_import, mock_subprocess):
        ...
        result = datashield.safety._bootstrap_import("module_inexistant")
        
        # subprocess.run ne doit jamais etre appele
        mock_subprocess.assert_not_called()
        # Le mode fallback doit etre active
        self.assertTrue(datashield.safety.USE_FALLBACK)
    ...
    def test_bootstrap_import_with_package_name(self, mock_import, mock_subprocess):
        ...
        result = datashield.safety._bootstrap_import("module_inexistant", "package_name")
    ...
    def test_bootstrap_import_preserves_fallback_flag(self, mock_import, mock_subprocess):
        ...
        mock_import.side_effect = ImportError("Module not found")
        result1 = datashield.safety._bootstrap_import("module_inexistant")
        ...
        mock_import.return_value = MagicMock()
        result2 = datashield.safety._bootstrap_import("module_existant")
