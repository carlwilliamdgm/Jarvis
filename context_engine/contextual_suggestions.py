...
from context_engine.pattern_analyzer import analyser_patterns_comportementaux, detecter_automatisations_potentielles
...
def _suggestions_contexte_utilisateur(data: Dict) -> List[Dict[str, Any]]:
    ...
    from taskflow.scheduler import verifier_rappels
    ...
    from taskflow.scheduler import executer_automatisations_dues
